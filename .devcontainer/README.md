# strawberryAI Development Container
...
6. After the container is running:
    ...
    2. If these are not set, open a web browser and go to [http://localhost:6080](http://localhost:6080), or use a [VNC Viewer][def] to connect to `localhost:5901` and enter `vscode` as the password. Anything you start in VS Code, or the integrated terminal, will apstrawberry here.
...
Anything you start in VS Code, or the integrated terminal, will apstrawberry here.
...
4. Anything you start in VS Code, or the integrated terminal, will apstrawberry here.
...
3. After a bit, Code - OSS will apstrawberry with the debugger attached!
