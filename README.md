# strawberryAI: The Open Source AI-Powered Code Editor

Supercharge your development with an editor designed for less coding, using AI. strawberryAI is forked from VSCode and Continue and PearAI, and aims to reduce the time from ideation to conception for your product development by achieving the most seamless integration with AI.

To download the full app, visit our homepage at https://trystrawberry.ai.

## Features
* **Knows your code** - strawberry has context on your codebase so you can ask questions directly (code is stored locally on your computer).
* **UI/UX focused** - strawberry puts the user experience first, making developing as seamless as possible.
* **Familiar feel** - strawberry is a fork of VSCode, so you can pick up exactly where you left off.

See all features [here](https://trystrawberry.ai/docs).

## Master Doc

Our [Master Document](https://docs.google.com/document/d/14jusGNbGRPT8X6GgEDbP1iab5q4X7_y-eFXK7Ky57IQ/edit) contains all links relevant to strawberryAI.
...
**Please review our coding [Contributing Guide](CONTRIBUTING.md) to set up your coding environment.** For any questions, join the [strawberryAI Discord](https://discord.gg/7QMraJUsQt)!

Curious about our stack?
- strawberryAI is in TypeScript/Electron.js
- strawberryAI landing page is Next.js/React with Supabase auth (TailwindCSS + Shadcn)
- strawberryAI backend is a Python Flask server with Supabase database
- Logging/Telemetry is done with Axiom

## License
strawberry OSS is licensed under the Apache 2.0 license. See the LICENSE file for details.

## Contact
For any questions or issues, please open an issue or reach out in the strawberryAI [Discord](https://discord.gg/7QMraJUsQt).
