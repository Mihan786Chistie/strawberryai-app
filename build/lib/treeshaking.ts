...
function findSymbolFromHeritageType(ts: typeof import('typescript'), checker: ts.TypeChecker, type: ts.ExpressionWithTystrawberryguments | ts.Expression | ts.PrivateIdentifier): ts.Symbol | null {
	if (ts.isExpressionWithTystrawberryguments(type)) {
