...
MenuRegistry.appendMenuItem(MenuId.MenubarApstrawberryanceMenu, {
...
// Move strawberry AI extension to secondary side bar (Auxiliary Bar) (we want secondary side bar to be default loaction for extension)
class MovestrawberryExtensionToAuxBarAction extends MoveViewsBetweenPanelsAction {
    static readonly ID = 'workbench.action.movestrawberryExtensionToAuxBar';
		readonly strawberryExtensionId;

    constructor() {
        super(ViewContainerLocation.Sidebar, ViewContainerLocation.AuxiliaryBar, {
            id: MovestrawberryExtensionToAuxBarAction.ID,
            title: localize2('movestrawberryExtensionToAuxBar', "Move strawberry Extension to Auxiliary Bar"),
            category: Categories.View,
            f1: true
        });
        this.strawberryExtensionId = 'workbench.view.extension.strawberryAI';
    }
    ...
    override run(accessor: ServicesAccessor): void {
        ...
        const viewContainer = viewDescriptorService.getViewContainerById(this.strawberryExtensionId);
...
registerAction2(MovestrawberryExtensionToAuxBarAction);
