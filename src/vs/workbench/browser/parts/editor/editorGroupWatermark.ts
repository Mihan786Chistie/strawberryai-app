...
const openstrawberryAIChat: WatermarkEntry = { text: localize('watermark.openstrawberryAIChat', "Open Chat"), id: 'strawberryai.focusContinueInput', when: ContextKeyExpr.has('strawberryAIExtensionLoaded') };
const bigChat: WatermarkEntry = { text: localize('watermark.strawberryAIBigChat', "Big Chat"), id: 'strawberryai.resizeAuxiliaryBarWidth', when: ContextKeyExpr.has('strawberryAIExtensionLoaded') };
const prevChat: WatermarkEntry = { text: localize('watermark.strawberryAIPrevChat', "Previous Chat"), id: 'strawberryai.loadRecentChat', when: ContextKeyExpr.has('strawberryAIExtensionLoaded') };
...
export class EditorGroupWatermark extends Disposable {
	...
	private async render(): Promise<void> {
		...
		this.contextKeyService.createKey('strawberryAIExtensionLoaded', true); // Set a context key when the strawberryAI extension is loaded
