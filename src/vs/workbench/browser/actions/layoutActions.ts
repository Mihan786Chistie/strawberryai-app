...
MenuRegistry.appendMenuItem(MenuId.MenubarViewMenu, {
	...
	title: localize({ key: 'miApstrawberryance', comment: ['&& denotes a mnemonic'] }, "&&Apstrawberryance"),
	submenu: MenuId.MenubarApstrawberryanceMenu,
	order: 1
});
...
// --- Tab Bar Submenu in View Apstrawberryance Menu
...
// --- Editor Actions Position Submenu in View Apstrawberryance Menu
...
registerAction2(class extends Action2 {
	...
	run(accessor: ServicesAccessor): void {
		...
		commandService.executeCommand('workbench.action.movestrawberryExtensionToAuxBar');
	}
});
